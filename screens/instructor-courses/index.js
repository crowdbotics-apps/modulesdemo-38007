...
const InstructorCourses = () => {
  return <ScrollView style={styles.container}>
      <View style={styles.headerContainer}>
        ...
        <View style={styles.headerBottom}>
          <View style={styles.starContainer}>
            ...
            <Text style={styles.starText}><Text style={styles.ratingText}>4.9 </Text>(100 reviews)</Text>
          </View>
      ...
      <Text style={styles.title}>Instructos courses</Text>
      ...
      <View style={styles.centerBox}>
        ...
        <View style={styles.box}>
         ...
         <View style={styles.boxBottom}>
            ...
            <Text style={styles.courseDesc}>Web Design for begginers</Text>
        ...
        <View style={[styles.box, styles.color]}>
          <View style={styles.courseTop}>
            <Image source={require("./assets/circle-star.png")} style={styles.circle} />
            <Text style={styles.rateLabel}>4.7</Text>
          </View>
          <View style={styles.imageBox}>
            <Image source={require("./assets/edit.png")} style={styles.editImg} />
