...
const PlaceBidScreen = params => {
  return <ScrollView style={styles.container}>
      ...
      <View style={[styles.chooseContainer, styles.RceRubwl]}>
      ...
      <View style={[styles.chooseContainer, styles.ZdSvPZZp]}>
        <Image source={require("./assets/minus.png")} style={styles.priceImg} />
      ...
      <View>
        <Text style={[styles.mr10, styles.eVLEvZCw]}>Service fee</Text>
        <View style={styles.feeSection}>
          <Text>0.25 ETF</Text>
        </View>
      </View>
      <View>
        <Text style={[styles.mr10, styles.UhvNxVqj]}>You will pay </Text>
        <View style={styles.feeSection}>
          <Text>3.14 ETH</Text>
        </View>
      </View>
