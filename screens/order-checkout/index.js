...
const DebitCard = props => {
  return <View style={debitCardStyles.container}>
      <View style={debitCardStyles.upperHalf}>
        ...
        <View style={debitCardStyles.cardTypeContainer}>
          {props.cardDetails.type === "Visa" ? <Image source={require("./assets/visa.png")} style={debitCardStyles.cardTypeImage} /> : <Image source={require("./assets/masterCard.png")} style={debitCardStyles.cardTypeImage} />}
        </View>
      </View>
