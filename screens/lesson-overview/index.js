  ...
  return <ScrollView style={styles.container}>
        ...
        <View style={styles.box}>
          ...
          <View style={styles.imageBox}>
            <View style={styles.innerBox}>
              <Image source={require("./assets/play.png")} style={styles.editImg} />
      ...
      <View style={styles.descContainer}>
        <Text style={styles.desc}>
          Lorem ipsum dolor sit UX/UI, consectetur adipiscing elit. Convallis odio habitasse nisl, odio senectus purus. Lorem risus aenean lectus vestibulum eleifend elit vel aliquam egestas. Morbi blandit id enim in.
        </Text>
        <Text style={styles.desc}>
          Lorem ipsum dolor sit UX/UI, consectetur adipiscing elit. Convallis odio habitasse nisl, odio senectus purus. Lorem risus aenean lectus vestibulum eleifend elit vel aliquam egestas. Morbi blandit id enim in.
        </Text>
