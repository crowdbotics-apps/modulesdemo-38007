...
const StakingRequirements = () => {
  ...
  useEffect(() => {
    setStakingRequirements({
      ...
      description: "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sit urna condimentum amet nulla dignissim. Non nullam et non lacinia tincidunt sed et metus duis. Tellus nullam lacus, bibendum nisl vitae est. Et, in donec purus tristique. Commodo mattis eu.",
      remainigTokens: 825
    });
  }, []);
  return <View style={styles.container}>
      <Text style={styles.heading}>Staking Requirements</Text>
      <TabView tabTitles={["Your 32 ETH", "Validator Keys", "Entrusted node operations"]} selected={selectedTab} onPress={setSelectedTab} />
