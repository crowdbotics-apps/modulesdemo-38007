  ...
  return <View style={styles.container}>
      ...
      <View style={styles.cardContainer}>
        <View style={styles.flexRow}>
          ...
          <Image style={styles.icon} source={require("./assets/dropdownIcon.png")} />
        </View>
      ...
      <View style={styles.cardContainer}>
        ...
        <View style={styles.daysContainer}>
          {days.map((day, index) => <View style={styles.dayItem} key={index}>
              <Checkbox value={selectedDays.includes(day)} setValue={() => handleDayPress(day)} />
      ...
      <Footer titles={["Home", "Task", "Availability", "Account", "My Business"]} images={[require("./assets/homeIcon.png"), require("./assets/listIcon.png"), require("./assets/availabilityIconActive.png"), require("./assets/accountIcon.png"), require("./assets/businessIcon.png")]} active={2} />
    </View>;
};
