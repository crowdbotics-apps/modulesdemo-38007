      ...
      setModalVisible(!modalVisible);
        ...
        <View style={styles.centeredView}>
          <View style={styles.modalView}>
            <View style={styles.orderContainer}>
              <View style={styles.rideHeader}>
                <View style={styles.flexRow}>
                  ...
                  <View style={styles.flexRow}>
                    <Image style={styles.headerIcon} source={require("./assets/chatIcon.png")} />
                    <Image style={styles.headerIcon} source={require("./assets/callIcon.png")} />
                  </View>
                </View>
              ...
              <View style={styles.locationContainer}>
                <Image source={require("./assets/dropOffIcon.png")} style={styles.dropOffIcon} />
            ...
            <Button buttonText={"Done"} onPress={() => setModalVisible(!modalVisible)} outlineColor="#000" color="#fff" textColor="#000" style={styles.button} />
          </View>
        </View>
      </Modal>
