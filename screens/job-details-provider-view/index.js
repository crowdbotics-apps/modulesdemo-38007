...
const JobDetailsProviderViewScreen = () => {
  return <ScrollView>
      <View style={styles.container}>
        ...
        <View style={[styles.chooseContainer, styles.ULdlMxZu]}>
          <Text>8</Text>
        </View>
        ...
        <View style={styles.sliderTextContainer}>
          ...
          <Text style={[styles.sliderText, styles.fJnPdoMM]}>$80k</Text>
        </View>
        ...
        <View style={styles.walletCard}>
          <View style={styles.walletInner}>
            <View style={[styles.imgContainer, styles.UcICVyuC]}>
        ...
        <View style={styles.walletCard}>
          <View style={styles.walletInner}>
            <View style={[styles.imgContainer, styles.fNuGUUIW]}>
              <Image source={require("./assets/edit.png")} style={styles.image} />
            </View>
