  ...
  return <ScrollView style={styles.container}>
      ...
      <View style={styles.chooseContainer}>
        <View style={styles.sectionContainer}>
          ...
          <View style={[styles.checkboxContainer, styles.aWYrekiq]}>
      ...
      <View style={styles.dateTimeContainer}>
        ...
        <Text style={[styles.mr10, styles.MzWXttdO]}>Starting time</Text>
      </View>
      <View style={[styles.chooseContainer, styles.EMiDAfqO]}>
        <Text></Text>
        <Text>09:00 AM</Text>
      </View>
