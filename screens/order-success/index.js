  ...
  return <View style={styles.container}>
      <View style={styles.body}>
        <View style={styles.circle}>
          <Image source={require("./assets/checkIcon.png")} style={styles.check} />
        </View>
      ...
      <Button buttonText="Track order" style={styles.button} color="#fff" textColor="#000" outlineColor="#000" />
    </View>;
};
