...
const OrdersInProgress = () => {
  ...
  return <View style={styles.container}>
      <FlatList showsVerticalScrollIndicator={false} ListHeaderComponent={() => <TabView tabTitles={["In Progress", "Completed"]} selected={selectecTab} onPress={setSelectedTab} style={styles.tabView} />} data={orders} keyExtractor={item => item.id.toString()} renderItem={({
      item
