...
const SetYourRate = () => {
  ...
  useEffect(() => {
    setClientRate(17);
    setSkills(["Skills name", "Skills name", "Skills name", "Skills name", "Skills name", "Skills name", "Skills name", "Skills name", "Skills name"]);
  }, []);
  ...
  return <View style={styles.container}>
      <ScrollView showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.rateContainer}>
          ...
          <View style={[styles.rateCircle, userRate < clientRate && styles.red]}>
            <Text style={[styles.rateText, userRate < clientRate && styles.red]}>
              ${userRate}/hr
            </Text>
          ...
          <Text style={styles.description}>
            {userRate < clientRate ? "Based on market supply & demand and similar Tasker experience, you could be earning more at a Tasker rate of $" + clientRate + "/hr" : "Based on market supply & demand and similar Tasker experience, you are earning good at a rate of $" + userRate + "/hr"}
          </Text>
          <Pressable>
            <Text style={userRate < clientRate ? styles.red : styles.greenText}>
        ...
        <View style={styles.skillsContainer}>
          ...
          <View style={styles.skillsItems}>
            {skills.map((skill, index) => <Pressable style={[styles.skill, selectedSkills.includes(index) && styles.selectedSkill]} key={index} onPress={() => handleSkills(index)}>
                <Text>{skill}</Text>
              </Pressable>)}
          </View>
        </View>
        <Text style={styles.heading}>Description</Text>
        <Input placeholder="Type instructions here ..." textArea={true} value={description} onChange={setDescription} />
