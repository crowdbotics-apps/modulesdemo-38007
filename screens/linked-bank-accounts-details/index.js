...
const LinkedBankAccountsDetails = () => {
  ...
  return <View style={styles.container}>
      ...
      <TabView tabTitles={["Personal", "Investment"]} selected={selectedTab} onPress={setSelectedTab} style={styles.tabView} />
      <Text style={styles.listText}>List of all accounts</Text>
      {bankAccounts.map((account, index) => <View key={index}>
          <View style={styles.nameContainer}>
            <Text style={styles.name}>{account.name}</Text>
            <Checkbox value={selectedBankAccounts.includes(account)} setValue={() => handleSelect(account)} />
          </View>
